...
public class Documents {
    ...
    public static class Meta {
        @SerializedName("total_count") public Integer total_count; // 검색어에 검색된 문서 수
        @SerializedName("pageable_count") public Integer pageable_count; // total_count 중 노출 가능 문서 수 (최대: 45)
